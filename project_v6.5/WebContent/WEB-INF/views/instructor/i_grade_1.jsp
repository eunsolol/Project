														...
														<tr>
															...
															<td><a href="#" title="Java레벨업"
																...
																data-content='<img src="${pageContext.request.contextPath}/resources/img/header.jpg"><div class="text-center">저자 : 마이크 / 가격 : 5,000원 / 출판사 : 한빛미디어</div>'>
																	${ing.book_name}</a></td>
															<td><a
																href="${pageContext.request.contextPath}/i/grade/info?instructor_id=${sessionScope.login.instructor_id}&os_id=${ing.os_id}">
														<button type="button" 
														...
														<tr>
															...
															<td><a href="#" title="Java레벨업"
																...
																data-content='<img src="${pageContext.request.contextPath}/resources/img/header.jpg"><div class="text-center">저자 : 마이크 / 가격 : 5,000원 / 출판사 : 한빛미디어</div>'>
																	${due.book_name}</a></td>
															<td><a
																		href="${pageContext.request.contextPath}/i/grade/info?instructor_id=${sessionScope.login.instructor_id}&os_id=${due.os_id}">
																<button type="button" 
																	class="btn btn-default btn-icon" title="조회">
																	<i class="fa fa-search-plus"></i>
																</button></a></td>
															...
															<tr>
																...
																<td><a href="#" title="Java레벨업"
																	...
																	data-content='<img src="${pageContext.request.contextPath}/resources/img/header.jpg"><div class="text-center">저자 : 마이크 / 가격 : 5,000원 / 출판사 : 한빛미디어</div>'>
																		${pre.book_name}</a></td>
																<td><a
																	href="${pageContext.request.contextPath}/i/grade/info?instructor_id=${sessionScope.login.instructor_id}&os_id=${pre.os_id}">
