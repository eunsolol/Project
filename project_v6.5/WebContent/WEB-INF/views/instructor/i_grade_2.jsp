			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<form action="" method="post">
						...
						<div class="form-group">
							<label for="pw">수강생번호:</label> <input type="password"
								class="form-control" id="stuNum" name="stuNum"
								placeholder="max 20" required>
						</div>
						<div class="form-group">
							<label for="pw">출결배점:</label> <input type="password"
								class="form-control" id="ap" name="ap" placeholder="max 20"
								required>
						</div>
						<div class="form-group">
							<label for="pw">필기배점:</label> <input type="password"
								class="form-control" id="wp" name="wp" placeholder="max 20"
								required>
						</div>
						<div class="form-group">
							<label for="pw">실기배점:</label> <input type="password"
