						...
						<div class="card">
							...
							<div class="card-header text-right">
								...
								<button type="button" class="btn btn-default btn-icon btnDel"
                                            data-toggle="modal" data-target="#insert" title="배점 입력">
					...
					<form>
						<div class="card card-plain">
							<div class="form-group">
								<label for="id">출결배점(최소20점):</label> <input type="number"
									class="form-control" id="ap" name="ap" placeholder="max 20"
									required>
							</div>
							<div class="form-group">
								<label for="pw">필기배점:</label> <input type="number"
									class="form-control" id="wp" name="wp" placeholder="max 20"
									required>
							</div>
							<div class="form-group">
								<label for="pw">실기배점:</label> <input type="number"
									class="form-control" id="pp" name="pp" placeholder="max 20"
									required>
							</div>
							<div class="form-group">
								<label for="pw">시험일자:</label> <input type="date"
									class="form-control" id="examDate" name="examDate"
									placeholder="max 20" required>
							</div>
							<label for="pw">시험문제:</label>
	...
	<div id="delete" class="modal fade" role="dialog">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<b>OS12 (Oracle)</b>의 <b>E03(2018-09-30)</b>
					<p>배점 정보를 삭제하시겠습니까?</p>
